...
export const COMPANY_DETAIL = {
  ...
  1: {
    companyName: '코리아교육그룹',
    companyJobGroup: '교육 서비스, IT',
    logoSrc: '/img/company/co-logo.jpg',
    intro: [
      '코리아교육그룹은 취업·디자인·IT 분야 전문 교육기관으로, 수강생 취업 연계 플랫폼 FindMe를 운영합니다.',
      '2010년 설립 이후 누적 수강생 10만 명을 돌파하였으며, 산학협력 기업 300개사와 직접 취업 연계를 통해 높은 취업률을 자랑합니다.',
    ],
    welfare: ['• 4대보험\n• 연차 제공\n• 유연근무\n• 식비 지원(월 10만원)\n• 교육비 전액 지원\n• 경조사비\n• 건강검진'],
    links: [
      { label: '코리아교육그룹 공식 홈페이지', href: 'https://www.koreaedugroup.com' },
    ],
    table: [
      { label: '산업분류', value: '교육 서비스, IT' },
      { label: '설립일',   value: '2010년 설립 (14년차)' },
      { label: '매출',     value: '500억원' },
      { label: '기업유형', value: '중견기업' },
      { label: '사원수',   value: '200명' },
      { label: '홈페이지', value: 'https://www.koreaedugroup.com', isLink: true },
    ],
    address: '서울특별시 강남구 테헤란로 123 코리아교육타워 5층',
    welfareKeywords: ['4대보험', '연차', '유연근무', '교육비지원'],
  },
  3: {
    companyName: '와이즐리',
...
export const RECRUIT_DETAIL = {
  ...
  1: {
    companyId: 1, companyJobGroup: '교육 서비스, IT',
    jobGroup: '웹디자인·IT',
    duty: 'UI/UX 디자인',
    period: '상시채용',
    images: ['/img/company/company-img1.jpg', '/img/company/company-img2.jpg', '/img/company/company-img1.jpg'],
    description: '코리아교육그룹은 취업·디자인·IT 전문 교육기관입니다.\n\n수강생 취업 연계 플랫폼 FindMe의 UI/UX 개선을 함께할 신입 디자이너를 모집합니다.',
    duties: '• FindMe 플랫폼 UI/UX 기획 및 디자인\n• 수강생·기업 사용자 인터페이스 개선\n• 디자인 시스템 구축 및 유지보수',
    requirements: '• Figma 활용 능숙자\n• 포트폴리오 제출 필수\n• 사용자 중심 사고 가능한 분',
    address: '서울특별시 강남구 테헤란로 123',
    welfare: ['4대보험', '연차', '유연근무', '교육비지원'],
    companyService: '코리아교육그룹은 취업 연계 전문 교육기관으로, 산학협력 기업 300개사와 함께 수강생의 취업을 직접 연결합니다.',
    companyDetails: [
      { label: '주요산업', value: '교육 서비스, IT' },
      { label: '설립연도', value: '2010년(14년차)' },
      { label: '기업형태', value: '중견기업' },
      { label: '매출액', value: '500억원' },
      { label: '사원수', value: '200명' },
      { label: '회사주소', value: '서울특별시 강남구 테헤란로 123' },
      { label: '홈페이지', value: 'https://www.koreaedugroup.com', isLink: true },
    ],
  },
  3: {
